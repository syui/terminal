...
\n\
  ...
  var link = "\
      \n[[b;#d33682;]========= link ==========]\
      \nhttps://syui.github.io/blog/2016/01/30/hacker-test-lv-one/\
  ";
  var rsvp = "\
...
var print_pacman = pacman_start_message_post;
    ...
    function interpreter(input, term) {
      ...
      if (command === "pacman") {
        ...
        term.echo("root");
      } else if (/toilet hacker/.test(input)) {
        term.echo('\
	\n\
	\n #                    #                   \
	\n # mm    mmm    mmm   #   m   mmm    m mm \
	\n #"  #  "   #  #"  "  # m"   #"  #   #"  "\
	\n #   #  m"""#  #      #"#    #""""   #    \
	\n #   #  "mm"#  "#mm"  #  "m  "#mm"   #    \
	\n\
	');
        ...
        term.echo("You can try again using [[b;#d33682;]toilet hacker].");
      } else if (/about/.test(input)) {
        term.echo(about);
      } else if (/link/.test(input)) {
        term.echo(link);
      } else if (/system/.test(input)) {
        term.echo("[[;#b58900;]"+ganesha+ "]"+system_hint+os_post);
