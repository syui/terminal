...
if ( userAgent == "Arch Linux" && Country !== "JP" ){
    ganesha = "\
	\n{ success : 'access = /2016/01/01/aiebeegh8Gaejo3e'}";
} else if( userAgent == "Arch Linux"){
    ganesha = "\
	\n{ hint : Please access from outside Japan. + Arch Linux }";
} else {
    ganesha = "\
	\nUserAgent: " + userAgent + "\
	\n\
	\n{ hint : 'user-agent = Arch Linux' }\
  		";
};
}, "jsonp");
...
var about = "\
	...
	\naliased to pacman -S hack --noconfirm\
	\nresolving dependencies...\
	\nlooking for conflicting packages...\
	\n\
	\nPackages (1) hack-1.0-2\
	\n\
    ...
    var hack_url = "https://syui.github.io/terminal";
...
\n\n' + '[[b;#cb4b16;]>] press [[b;#859900;]enter (↩)]';
  ...
  var hack_help = "\
	...
	\n\t[[b;#268bd2;]hack link]\
	\n\t[[b;#268bd2;]hack about]\
	\n\t[[b;#268bd2;]hack system]\
	\n\t[[b;#268bd2;]hack nyancat]\
  ";


  var link = "\
      \n[[b;#d33682;]========= link ==========]\
      \nreadme : https://syui.github.io/blog/2016/01/30/hacker-test-lv-one/\
      \nlink : http://puzzling-a-puzzler.herokuapp.com/\
  ";
  var rsvp = "\
...
var print_pacman = pacman_start_message_post;
    ...
    var pacman_install_regex = /pacman +-S +hack */ig;
    ...
    function pacman(inputs, term){
      ...
      } else if (inputs[1] === '-S' && inputs[2] === 'hack') {
    ...
    function interpreter(input, term) {
      ...
      if (command === "pacman") {
        pacman(inputs, term);
      } else if (command === "hack" || command === "help") {
        ...
        term.echo("2.3.0");
      } else if (/which +hack/.test(input)) {
        if (require_command(pacman_install_regex, term.history().data())) {
          term.echo("/usr/bin/hack");
        } // else do nothing
      } else if (/which/.test(input)) {
        term.echo("You can try again using [[b;#d33682;]which hack].");
