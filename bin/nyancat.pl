...
# Author : moshen  
#   https://gist.github.com/moshen/1417991
my @frames = ( q(
...
my $options = {};
GetOptions( "loop_times=i" => \$options->{loop_t},
...
Uses utf8 'half-block' characters to effectively double the
...
This is a port of nyan in the L<Image::Term256Color> perl distribution 
so it can be run on it's own, without installing any perl modules.
It includes Nyancat animation frames within the script for enjoyment
